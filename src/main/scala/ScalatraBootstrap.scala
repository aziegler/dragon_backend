...
import com.ziegler.dragon.models.{Dice, Theme}
...
class ScalatraBootstrap extends LifeCycle {
  ...
  //  configureDb()
    ...
    val codeRegistry = fromRegistries(fromProviders(classOf[Theme],classOf[Dice]), DEFAULT_CODEC_REGISTRY)
    ...
    context.mount(new BackendController (themesColl, diceColl),"/*")
  }
